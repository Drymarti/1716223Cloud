...
#Loop for receiving popular tweets. For top 10 popular tweets in India 
for tweet in search_result[0]["popular"][:10]:
    print(tweet["tweets"]) #Output the tweet
    print(tweet["statuses"]) #Output of tweet's content and user
    print(tweet["search_metadata"])  #More metadata about tweet
    
    
#Loop for receiving popular tweets. For top 50 popular tweets in India 
for tweet in search_result[0]["popular"][:50]:
    print(tweet["tweets"]) #Output the tweet
    print(tweet["statuses"]) #Output of tweet's content and user
    print(tweet["search_metadata"])  #More metadata about tweet
        
#Loop for receiving popular tweets. For top 100 popular tweets in India 
for tweet in search_result[0]["popular"][:100]:
    print(tweet["tweets"]) #Output the tweet
    print(tweet["statuses"]) #Output of tweet's content and user
    print(tweet["search_metadata"])  #More metadata about tweet
